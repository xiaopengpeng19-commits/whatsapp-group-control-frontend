    ...
    <div class="groups">
        ...
        <div class="toolbar">
            <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;">
                <el-select v-model="filterAccount" placeholder="全部账号" clearable @change="fetchGroups"
                    style="width:160px">
                    <el-option label="全部账号" value="" />
                    <el-option v-for="acc in accountList" :key="acc" :label="acc" :value="acc" />
                </el-select>
                <el-select v-model="filterStatus" placeholder="全部状态" clearable @change="fetchGroups"
                    style="width:120px">
        ...
        <el-row :gutter="20" style="margin-bottom:20px;">
            <el-col :span="6">
                <el-card>
                    <div style="text-align:center;">
                        <div style="font-size:24px;color:#409eff;">{{ total }}</div>
            ...
            <el-col :span="6">
                <el-card>
                    <div style="text-align:center;">
                        <div style="font-size:24px;color:#67c23a;">{{ activeCount }}</div>
            ...
            <el-col :span="6">
                <el-card>
                    <div style="text-align:center;">
                        <div style="font-size:24px;color:#909399;">{{ leftCount }}</div>
            ...
            <el-col :span="6">
                <el-card>
                    <div style="text-align:center;">
                        <div style="font-size:24px;color:#e6a23c;">{{ accountCount }}</div>
        ...
        <el-table :data="groups" v-loading="loading" border>
            ...
            <el-table-column prop="size" label="群人数" width="80" align="center" />
        ...
        <!-- 同步对话框 -->
        <el-dialog v-model="showSyncDialog" title="同步群组" width="500px">
            <el-form :model="syncForm" label-width="80px">
                <el-form-item label="选择账号">
                    <el-select v-model="syncForm.account" placeholder="选择要同步的账号" style="width:100%">
                        <el-option v-for="acc in accountList" :key="acc" :label="acc" :value="acc" />
                    </el-select>
                </el-form-item>
            </el-form>
...
const handleDelete = async (row) => {
    try {
        await ElMessageBox.confirm(`确定要删除群组 "${row.subject}" 的记录吗？`, '提示', { type: 'warning' })
